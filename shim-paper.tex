...
range~\cite{bib:msr_rsi}, with a significant probability of improvement
with more careful degaussing.  In the new n2EDM shield, the PSI collaboration
also demonstrated a magnetic-field non-uniformity of $\sigma(B_z)=27$~pT over
a cylindrical volume of radius 40~cm and height 30~cm~\cite{bib:n2edm-uniformity2025}. 
The homogeneity improved to 300 pT in 1.4 m$^3$ after more detailed degaussing studies \cite{bib:Segarra2024Degaussing}
and the degaussing time was substantially reduced.  The homogeneity in
the PanEDM experiment shield was demonstrated to be to be less than 300~pT/m~\cite{bib:Altarev2014MSR}.
Other similarly sized MSRs have demonstrated even better
homogeneity, with residual fields below 130~pT in a
0.5\times0.5\times0.5~m$^3$ volume \cite{bib:Sun2021Limits}, [Fierlinger new shield].
